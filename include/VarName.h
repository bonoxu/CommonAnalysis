...
public:
    ...
    static std::string GetName(VARIABLE var)
    {
        switch (var)
        {
            ...
            case E_EHCAL_ALL_RATIO:
                return "EEHCalAllRatio";
            ...
            case N_CHARGEPHOTON_PFO:
                return "nChargePhotonPfo";
            case M_CHARGEPHOTON_PFO:
                return "mChargePhotonPfo";
            case E_CHARGEPHOTON_PFO:
                return "eChargePhotonPfo";
